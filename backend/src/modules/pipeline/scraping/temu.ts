/**
 * Stub — Temu extension export reader.
 *
 ...
 * the raw payload to `PIPELINE_RAW_DIR/temu/<capturedAt>.json`, and
...
export async function readTemuExtensionExport(
  ...
  void exportPath;
  throw new Error(
    'temu: not implemented yet; see PR 5 (extension-based-sources)',
  );
}
